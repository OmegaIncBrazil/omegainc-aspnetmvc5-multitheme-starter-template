    ...
    */
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            actionDropDown: "<div class=\"{{css.dropDownMenu}}\"><button class=\"btn btn-secondary dropdown-toggle\" type=\"button\" data-toggle=\"dropdown\"><span class=\"{{css.dropDownMenuText}}\">{{ctx.content}}</span> </button><ul class=\"{{css.dropDownMenuItems}}\" role=\"menu\"></ul></div>",
